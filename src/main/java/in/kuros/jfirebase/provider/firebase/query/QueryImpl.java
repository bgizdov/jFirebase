...
abstract class QueryImpl<T> implements Query<T> {
  ...
  private List<Function<com.google.cloud.firestore.Query, com.google.cloud.firestore.Query>>
      queries;
  ...
  @Override
  public <K, V> Query<T> whereEqualTo(final MapAttribute<T, K, V> field, final K key,
      final V value) {
  ...
  @Override
  public <K, V> Query<T> whereNotEqualTo(final MapAttribute<T, K, V> field, final K key,
      final V value) {
  ...
  @Override
  public <X> Query<T> whereArrayContainsAny(final Attribute<T, X> field,
